# this version has no keepalive, as the tcp connection is made, it will shutdown after 1 - 2 minutes if there is nothing send during this time.
# you then have to open the connection again.
#fix at V04
